...
const EncoderKeyContent = styled.div`
  ...
  background-image: radial-gradient(currentColor 21px, transparent 22px),
    radial-gradient(rgba(255, 255, 255, 0.6) 21px, transparent 22px),
    radial-gradient(rgba(0, 0, 0, 0.2) 21px, transparent 23.5px),
    radial-gradient(rgba(0, 0, 0, 0.2) 21px, transparent 23.5px);
  background-size: 52px 52px;
  background-position: 0px 0px, -0.5px -0.5px, 0px 0px, 2.5px 2.5px;

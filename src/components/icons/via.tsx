...
export const VIALogo = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox="0 0 53.6 26" xmlSpace="preserve" {...props}>
      ...
      <circle cx={12} cy={31.7} r={1.9} />
      <circle cx={41.2} cy={31.7} r={1.9} />
      <path d="M21.3 27.2l-.4-.2c-1.1-.4-1.6-1.6-1.2-2.7l8.7-22.6C28.8.6 30 .1 31.1.5l.4.2c1.1.4 1.6 1.6 1.2 2.7L24 26c-.5 1-1.7 1.6-2.7 1.2z" />
      <path d="M34.4 33.1H18.8c-.6 0-1-.4-1-1v-.7c0-.6.4-1 1-1h15.6c.6 0 1 .4 1 1v.7c0 .5-.4 1-1 1z" />
    </svg>
  );
};

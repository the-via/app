...
export function getKeycodes(numMacros = 16): IKeycodeMenu[] {
  return [
    ...
    /* These are for controlling the original backlighting and bottom RGB. */
    {
      ...
      width: 'label',
      keycodes: [
        {name: 'BL Toggle', code: 'BL_TOGG', shortName: 'BL Tog', title: 'Turn the backlight on or off'},
        {name: 'BL On', code: 'BL_ON', shortName: 'BL On', title: 'Set the backlight to maximum brightness'},
        {name: 'BL Off', code: 'BL_OFF', shortName: 'BL Off', title: 'Turn the backlight off'},
        {name: 'BL -', code: 'BL_DEC', shortName: 'BL -', title: 'Decrease the backlight level'},
        {name: 'BL +', code: 'BL_INC', shortName: 'BL +', title: 'Increase the backlight level'},
        {name: 'BL Cycle', code: 'BL_STEP', shortName: 'BL Cycle', title: 'Cycle through backlight levels'},
        {name: 'BL Breathe', code: 'BL_BRTG', shortName: 'BL Breathe', title: 'Toggle backlight breathing'},
        {name: 'RGB Toggle', code: 'RGB_TOG', shortName: 'RGB Tog', title: 'Toggle RGB lighting on or off'},
        {name: 'RGB Mode-', code: 'RGB_RMOD', shortName: 'Mode-', title: 'Cycle through modes in reverse'},
        {name: 'RGB Mode+', code: 'RGB_MOD', shortName: 'Mode+', title: 'Cycle through modes'},
        {name: 'RGB Hue-', code: 'RGB_HUD', shortName: 'Hue-', title: 'Decrease hue'},
        {name: 'RGB Hue+', code: 'RGB_HUI', shortName: 'Hue+', title: 'Increase hue'},
        {name: 'RGB Sat-', code: 'RGB_SAD', shortName: 'Sat-', title: 'Decrease saturation'},
        {name: 'RGB Sat+', code: 'RGB_SAI', shortName: 'Sat+', title: 'Increase saturation'},
        {name: 'RGB Bright-', code: 'RGB_VAD', shortName: 'Bright-', title: 'Decrease brightness'},
        {name: 'RGB Bright+', code: 'RGB_VAI', shortName: 'Bright+', title: 'Increase brightness'},
        {name: 'RGB Speed-', code: 'RGB_SPD', shortName: 'Speed-', title: 'Decrease effect speed'},
        {name: 'RGB Speed+', code: 'RGB_SPI', shortName: 'Speed+', title: 'Increase effect speed'},
        {name: 'RGB Mode Plain', code: 'RGB_M_P', shortName: 'Mode P', title: 'Static mode'},
        {name: 'RGB Mode Breathe', code: 'RGB_M_B', shortName: 'Mode B', title: 'Breathing animation mode'},
        {name: 'RGB Mode Rain', code: 'RGB_M_R', shortName: 'Mode R', title: 'Rainbow animation mode'},
        {name: 'RGB Mode Swirl', code: 'RGB_M_SW', shortName: 'Mode SW', title: 'Swirl animation mode'},
        {name: 'RGB Mode Snake', code: 'RGB_M_SN', shortName: 'Mode SN', title: 'Snake animation mode'},
        ...
        {name: 'RGB Matrix Prev', code: 'RM_PREV', shortName: 'RM Prev', title: 'Cycle through animations in reverse'},
        {name: 'RGB Matrix Next', code: 'RM_NEXT', shortName: 'RM Next', title: 'Cycle through animations'},
        {name: 'RGB Matrix Hue-', code: 'RM_HUED', shortName: 'RM Hue-', title: 'Cycle through hue in reverse'},
        {name: 'RGB Matrix Hue+', code: 'RM_HUEU', shortName: 'RM Hue+', title: 'Cycle through hue'},
        {name: 'RGB Matrix Sat-', code: 'RM_SATD', shortName: 'RM Sat-', title: 'Decrease the saturation'},
        {name: 'RGB Matrix Sat+', code: 'RM_SATU', shortName: 'RM Sat+', title: 'Increase the saturation'},
        {name: 'RGB Matrix Bright-', code: 'RM_VALD', shortName: 'RM Bright-', title: 'Decrease the brightness level'},
        {name: 'RGB Matrix Bright+', code: 'RM_VALU', shortName: 'RM Bright+', title: 'Increase the brightness level'},
        {name: 'RGB Matrix Speed-', code: 'RM_SPDD', shortName: 'RM Spd-', title: 'Decrease the animation speed'},
        {name: 'RGB Matrix Speed+', code: 'RM_SPDU', shortName: 'RM Spd+', title: 'Increase the animation speed'},
      ],
    },
    /*

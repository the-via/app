...
export default {
   ...
   */
  // Row 1
  'S(KC_GRV)': { name: '~', alias: 'US_TILD', title: '~' },
  KC_TILD: { name: '~', alias: 'US_TILD', title: '~' },
  ...
  'S(KC_6)': { name: '^', alias: 'US_CIRC', title: '^' },
  KC_CIRC: { name: '^', alias: 'US_CIRC', title: '^' },
  ...
  'S(KC_QUOT)': { name: '"', alias: 'US_DQUO', title: '"' },
  KC_DQUO: { name: '"', alias: 'US_DQUO', title: '"' },
  // Row 4
   ...
   */
  // Row 1
  'ALGR(KC_GRV)': { name: '`', alias: 'US_DGRV', title: '◌̀ (dead)' },
  'ALGR(KC_1)': { name: '¹', alias: 'US_SUP1', title: '¹' },
  ...
  'ALGR(KC_6)': { name: '^', alias: 'US_DCIR', title: '◌̂ (dead)' },
  'ALGR(KC_7)': { name: '◌̛', alias: 'US_HORN', title: '◌̛ (dead)' },
  'ALGR(KC_8)': { name: '˛', alias: 'US_OGON', title: '◌̨ (dead)' },
  ...
  'ALGR(KC_R)': { name: 'Ë', alias: 'US_EDIA', title: 'Ë' },
   ...
   */
  // Row 1
  'S(ALGR(KC_GRV))': { name: '~', alias: 'US_DTIL', title: '◌̃ (dead)' },
  'S(ALGR(KC_1))': { name: '¡', alias: 'US_IEXL', title: '¡' },
  ...
  'S(ALGR(KC_6))': { name: '¼', alias: 'US_QRTR', title: '¼' },
  'S(ALGR(KC_7))': { name: '½', alias: 'US_HALF', title: '½' },
  'S(ALGR(KC_8))': { name: '¾', alias: 'US_TQTR', title: '¾' },
  ...
  'S(ALGR(KC_QUOT))': { name: '¨', alias: 'US_DIAE', title: '◌̈ (dead)' },
  // Row 4

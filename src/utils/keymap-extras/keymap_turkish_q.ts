...
export default {
  ...
  KC_MINS: { name: '?\n*', alias: 'TR_ASTR', title: '* and ?' },
  KC_EQL: { name: '_\n-', alias: 'TR_MINS', title: '- and _' },
  // Row 2
  KC_Q: { name: 'Q', alias: 'TR_Q', title: 'q and Q' },
  KC_W: { name: 'W', alias: 'TR_W', title: 'w and W' },
  KC_E: { name: 'E', alias: 'TR_E', title: 'e and E' },
  KC_R: { name: 'R', alias: 'TR_R', title: 'r and R' },
  KC_T: { name: 'T', alias: 'TR_T', title: 't and T' },
  KC_Y: { name: 'Y', alias: 'TR_Y', title: 'y and Y' },
  KC_U: { name: 'U', alias: 'TR_U', title: 'u and U' },
  KC_I: { name: 'I', alias: 'TR_I', title: 'i and I' },
  KC_O: { name: 'O', alias: 'TR_O', title: 'o and O' },
  KC_P: { name: 'P', alias: 'TR_P', title: 'p and P' },
  KC_LBRC: { name: 'Ğ', alias: 'TR_GBRV', title: 'ğ and Ğ' },
  KC_RBRC: { name: 'Ü', alias: 'TR_UDIA', title: 'ü and Ü' },
  // Row 3
  KC_A: { name: 'A', alias: 'TR_A', title: 'a and A' },
  KC_S: { name: 'S', alias: 'TR_S', title: 's and S' },
  KC_D: { name: 'D', alias: 'TR_D', title: 'd and D' },
  KC_F: { name: 'F', alias: 'TR_F', title: 'f and F' },
  KC_G: { name: 'G', alias: 'TR_G', title: 'g and G' },
  KC_H: { name: 'H', alias: 'TR_H', title: 'h and H' },
  KC_J: { name: 'J', alias: 'TR_J', title: 'j and J' },
  KC_K: { name: 'K', alias: 'TR_K', title: 'k and K' },
  KC_L: { name: 'L', alias: 'TR_L', title: 'l and L' },
  KC_SCLN: { name: 'Ş', alias: 'TR_SCED', title: 'ş and Ş' },
  KC_QUOT: { name: 'İ', alias: 'TR_IDOT', title: 'i̇ and İ' },
  KC_NUHS: { name: ';\n,', alias: 'TR_COMM', title: ', and ;' },
  // Row 4
  KC_NUBS: { name: '>\n<', alias: 'TR_LABK', title: '< and >' },
  KC_Z: { name: 'Z', alias: 'TR_Z', title: 'z and Z' },
  KC_X: { name: 'X', alias: 'TR_X', title: 'x and X' },
  KC_C: { name: 'C', alias: 'TR_C', title: 'c and C' },
  KC_V: { name: 'V', alias: 'TR_V', title: 'v and V' },
  KC_B: { name: 'B', alias: 'TR_B', title: 'b and B' },
  KC_N: { name: 'N', alias: 'TR_N', title: 'n and N' },
  KC_M: { name: 'M', alias: 'TR_M', title: 'm and M' },
  KC_COMM: { name: 'Ö', alias: 'TR_ODIA', title: 'ö and Ö' },
  KC_DOT: { name: 'Ç', alias: 'TR_CCED', title: 'ç and Ç' },
   ...
   */
  // Row 1
  'S(KC_GRV)': { name: 'é', alias: 'TR_EACU', title: 'é' },
  KC_TILD: { name: 'é', alias: 'TR_EACU', title: 'é' },
  'S(KC_1)': { name: '!', alias: 'TR_EXLM', title: '!' },
  KC_EXLM: { name: '!', alias: 'TR_EXLM', title: '!' },
  'S(KC_2)': { name: "'", alias: 'TR_QUOT', title: "'" },
  KC_AT: { name: "'", alias: 'TR_QUOT', title: "'" },
  'S(KC_3)': { name: '^', alias: 'TR_CIRC', title: '◌̂ (dead)' },
  KC_HASH: { name: '^', alias: 'TR_CIRC', title: '◌̂ (dead)' },
  'S(KC_4)': { name: '+', alias: 'TR_PLUS', title: '+' },
  KC_DLR: { name: '+', alias: 'TR_PLUS', title: '+' },
  ...
  'S(KC_7)': { name: '/', alias: 'TR_SLSH', title: '/' },
  KC_AMPR: { name: '/', alias: 'TR_SLSH', title: '/' },
  ...
  // Row 3
  'S(KC_NUHS)': { name: ';', alias: 'TR_SCLN', title: ';' },
  // Row 4
  'S(KC_NUBS)': { name: '>', alias: 'TR_RABK', title: '>' },
  'S(KC_SLSH)': { name: ':', alias: 'TR_COLN', title: ':' },
  KC_QUES: { name: ':', alias: 'TR_COLN', title: ':' },
   ...
   */
  // Row 1
  'ALGR(KC_2)': { name: '£', alias: 'TR_PND', title: '£' },
  'ALGR(KC_3)': { name: '#', alias: 'TR_HASH', title: '#' },
  'ALGR(KC_4)': { name: '$', alias: 'TR_DLR', title: '$' },
  ...
  'ALGR(KC_E)': { name: '€', alias: 'TR_EURO', title: '€' },
  'ALGR(KC_T)': { name: '₺', alias: 'TR_LIRA', title: '₺' },
  ...
  KC_LCBR: { name: 'Ğ', alias: 'S(TR_GBRV)', title: 'Ğ' },
  KC_RCBR: { name: 'Ü', alias: 'S(TR_UDIA)', title: 'Ü' },
  KC_LT: { name: 'Ö', alias: 'S(TR_ODIA)', title: 'Ö' },
  KC_GT: { name: 'Ç', alias: 'S(TR_CCED)', title: 'Ç' },
  KC_COLN: { name: 'Ş', alias: 'S(TR_SCED)', title: 'Ş' },
  KC_PIPE: { name: ';', alias: 'TR_SCLN', title: ';' },
  KC_DQUO: { name: 'İ', alias: 'S(TR_IDOT)', title: 'İ' },

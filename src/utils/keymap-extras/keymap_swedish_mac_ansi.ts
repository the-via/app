...
export default {
   ...
   */
  // Row 1
  'S(KC_GRV)': { name: '>', alias: 'SE_RABK', title: '>' },
  KC_TILD: { name: '>', alias: 'SE_RABK', title: '>' },
  ...
  'A(KC_NUHS)': { name: '@', alias: 'SE_AT', title: '@' },
  // Row 3
   ...
   */
  // Row 1
  'S(A(KC_GRV))': { name: '≥', alias: 'SE_GTEQ', title: '≥' },
  ...
  'S(A(KC_6))': { name: '¶', alias: 'SE_PILC', title: '¶' },
  ...
  // Row 2
  'S(A(KC_Q))': { name: '°', alias: 'SE_DEG', title: '°' },
